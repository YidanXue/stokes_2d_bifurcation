% MATLAB code to reproduce Fig. 2
...
P1 = 0;
P2 = 0;
% P0 = (24*(D1^3+D2^3+1)+D1^3*P1+D2^3*P2)/(D1^3+D2^3);

% solving the pressure at centre
% pc_a = (Dp^4*P0+D1^4*P1+D2^4*P2)/(Dp^4+D1^4+D2^4); %3D Poiseuille
% pc_a = (Dp^3*P0+D1^3*P1+D2^3*P2)/(Dp^3+D1^3+D2^3); %2D Poiseuille
